...
public class ShowOrderByUserAction {
	...
	public String execute() throws Exception {
		...
		System.out.println("HAHAH13");
		orders = jdbcAdminDao.findAllOrderByUser(User_id);
		totalNum = jdbcAdminDao.getOrderTotalNumByUser();
		this.size=5;
		System.out.println("HAHAH14 ");
		if (totalNum % size == 0) {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 ShowOrderByUserAction show = new ShowOrderByUserAction();
		 show.execute();
